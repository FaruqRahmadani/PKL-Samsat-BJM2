        ...
        <div class="box-body">
          {!! Form::open(['url'=>Request::url(),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="number" name="SantunanWajib" value="{{old('SantunanWajib')}}" required min=0>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="number" name="BiayaAdmin" value="{{old('BiayaAdmin')}}" required min=0>
              </div>
            </div>
