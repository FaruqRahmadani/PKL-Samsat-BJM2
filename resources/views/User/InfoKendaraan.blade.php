            ...
            {{-- <div class="form-group"> --}}
              ...
              <div class="col-lg-12 input-group input-group-lg">
                <select class="form-control" name="method" required autofocus>
                  ...
                  <option value="no_mesin">Nomor Mesin</option>
                  <option value="no_rangka">Nomor Rangka</option>
                </select>
              </div>
              <br>
              <div class="col-lg-12 input-group input-group-lg">
                <input class="form-control" type="text" name="inputan" value="{{old('inputan')}}" placeholder="Masukan Data" required pattern="[a-zA-Z0-9]+.{0,}" title="Minimal 1 Karakter">
