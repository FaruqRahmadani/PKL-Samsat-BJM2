    ...
    <section class="content-header">
      <h1>
        @section('title')
          Edit TNKB
        @endsection
        Edit TNKB - {{$JenisTNKB->jenis_tnkb}}
      </h1>
    </section>
        ...
        <div class="box-body">
          {!! Form::open(['url'=>Request::url(),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="text" name="JenisTNKB" value="{{$JenisTNKB->jenis_tnkb}}" required pattern="[a-zA-Z0-9]+.{0,}" title="Minimal 1 Karakter" autofocus>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <div class="input-group">
                  <input class="form-control" type="number" name="Bobot" value="{{$JenisTNKB->bobot}}" required pattern="[a-zA-Z0-9]+.{0,}" title="Minimal 1 Karakter" step="any">
