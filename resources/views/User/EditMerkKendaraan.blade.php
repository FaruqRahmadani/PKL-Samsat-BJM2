    ...
    <section class="content-header">
      <h1>
        @section('title')
          Edit Merk Kendaraan
        @endsection
        Edit Merk Kendaraan - {{$MerkKendaraan->merk}}
      </h1>
    </section>
        ...
        <div class="box-body">
          {!! Form::open(['url'=>Request::url(),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="text" name="NamaMerk" value="{{$MerkKendaraan->merk}}" required pattern="[a-zA-Z0-9]+.{0,}" title="Minimal 1 Karakter" autofocus>
              </div>
            </div>
