        ...
        <div class="box-body">
          {!! Form::open(['url'=>Request::url(),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <select class="form-control" name="idTipeKendaraan" id="tipe" required>
                  <option value="" hidden>Pilih Merk Kendaraan Dahulu</option>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="number" name="TahunBuat" value="{{old('TahunBuat')}}" required min="1500">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="number" name="NJKB" value="{{old('NJKB')}}" required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="number" name="Bobot" value="{{old('Bobot')}}" required step="any">
              </div>
            </div>
