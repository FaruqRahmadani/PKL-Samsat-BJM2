        ...
        <div class="box-header">
          <div class="col-md-12">
            ...
            <div class="callout callout-info">
              <p style="text-align:center;">Data Pendapatan PKB Keseluruhan</p>
            </div>
          </div>
        </div>
        <!-- /.box-header -->
            ...
            <tbody>
              @foreach ($Transaksi as $DataTransaksi)
                <tr>
                  ...
                  <td>Rp. {{number_format($DataTransaksi->pkb)}}</td>
                  <td>{{Carbon\Carbon::parse($DataTransaksi->Kendaraan->masalaku)->format('d-m-Y')}}</td>
                  <td>{{$DataTransaksi->Kendaraan->DaerahUPPD->nama_daerah}}</td>
                  <td>{{Carbon\Carbon::parse($DataTransaksi->created_at)->format('d-m-Y H:i A')}}</td>
                </tr>
              @endforeach
          </table>
          <div class="col-md-2 pull-right">
            <a href="/laporan-pendapatan-pkb/print" target="_blank">
