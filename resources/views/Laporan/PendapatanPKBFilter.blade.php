...
<html>
  ...
  <body>
    ...
    <br>
    <hr class="atas">
    <h5>Laporan Pendapatan PKB Tanggal : {{Carbon\Carbon::parse($TanggalAwal)->format('d-m-Y')}} - {{Carbon\Carbon::parse($TanggalAkhir)->format('d-m-Y')}}</h5>
    <hr class="bawah">
    <table>
      <thead>
          <tr>
              ...
              <th style="width: 100px;">Jenis TNKB</th>
              <th style="width: 50px;">Tipe Kendaraan</th>
              <th style="width: 90px;">PKB</th>
              <th style="width: 90px;">MasaLaku</th>
      ...
      <tbody>
        @foreach ($Transaksi as $DataTransaksi)
          <tr>
            ...
            <td style="padding-left: 5px;">Rp. {{number_format($DataTransaksi->pkb)}}</td>
            <td style="padding-left: 5px;">{{Carbon\Carbon::parse($DataTransaksi->Kendaraan->masalaku)->format('d-m-Y')}}</td>
